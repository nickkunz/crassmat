...
#' @examples 
#' ## crassmat example
#' A_training <- crassmat(sparse_matrix = A,        ## matrix
#'                        test_split_thres = 0.20,  ## percent sampled out of matrix from observed values
#'                        conditional = 1)          ## number of observed values in matrix to remain per row
#'
#' @export crassmat
