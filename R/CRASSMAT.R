...
#' @examples 
#' ## crassmat example
#' A_training <- crassmat(sparse_matrix = A,        ## data
#'                        test_split_thres = 0.20,  ## percent sampled out of matrix A from observed values
#'                        conditional = 1)          ## num of observed values to remain per row in matrix A
#'
#' @export crassmat
